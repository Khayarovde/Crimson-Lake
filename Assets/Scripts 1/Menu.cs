...
{
    [SerializeField]
    private GameObject menuUI;       //  Panel gameobject to show in the screen either the pause or the lost menu
    [SerializeField]
    private Text menuText;           //  Text of the menu title
    [SerializeField]
    private Text enemyState;         //  Text to show the state of the enemy on screen
